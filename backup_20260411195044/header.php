...
<head>
    ...
    *,*::before,*::after{box-sizing:border-box}
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('assets/css/facile-v2.css'); ?>" media="print" onload="this.media='all'">
    ...
    <noscript>
        ...
        <link rel="stylesheet" href="<?php $this->options->themeUrl('assets/css/facile-v2.css'); ?>" type="text/css">
