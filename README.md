...
本主题是基于 [Facile 2.5](https://github.com/changbin1997/Facile) 的修改版本。

## 主要修改内容

- **删除语言切换功能**：移除了多语言支持，主题固定使用中文显示，删除了语言切换设置选项、侧边栏语言选择组件、导航栏语言切换按钮及相关 JS 代码
- **卡片式列表**：将文章列表改为卡片式设计，提升视觉效果和阅读体验
- **优化主题配色**：减少了主题中红色元素的占比，采用更加简洁的黑白灰配色方案
- **固定小图头图样式**：文章列表头图固定为小图模式（文章标题和摘要在左侧，图片在右侧），移除了大头图样式选项及相关代码
- 原主题支持中英文双语切换，修改版简化为仅支持中文
...
* [ECharts](https://github.com/apache/echarts) 百度开源的图表库，用于统计页生成统计图
...
上网对于大多数人来说是一件再简单不过的事，但是对于一些身体有缺陷的残障人士来说是一件非常困难的事。目前国内的很多网站和 App 都只注重外观，忽略了残障人士的 [可访问性](https://www.misterma.com/archives/264/)，甚至有的 App 在开启屏幕阅读器的情况下都无法正常使用。
