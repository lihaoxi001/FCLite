            ...
            <div class="comment-author clearfix">
                ...
                <div class="comment-info float-left">
                    ...
                    <?php if ($comments->authorId == $comments->ownerId): ?>
                        <span class="badge badge-dark author-tag"><?php echo '作者'; ?></span>
                    <?php endif; ?>
                    <?php echo reply($comments->parent); ?>
                    <?php if ($comments->status != 'approved'): ?>
                        <span class="badge badge-dark" title="<?php echo '您的评论目前只有您自己能看到，审核通过后才会公开显示。'; ?>" data-toggle="tooltip" data-placement="top"><?php echo '评论审核中'; ?></span>
                    <?php endif; ?>
...
<div id="comments" aria-label="评论区">
    ...
    <?php if ($comments->have()): ?>
        <div class="comments-lists">
            <h2><?php $this->commentsNum(_t('暂无评论'), '仅有一条评论', '已有 %d 条评论'); ?></h2>

            <?php $comments->listComments(); ?>

            <nav class="page-nav my-5" aria-label="<?php echo '评论分页'; ?>">
                <?php bootstrap4Pagination($comments, '上一页', '下一页'); ?>
            </nav>
