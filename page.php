                ...
                <article class="mb-4 border-bottom">
                    ...
                    <div class="post-info mt-2">
                        <span class="ml-1" title="<?php echo '发布日期'; ?>" data-toggle="tooltip" data-placement="top">
                            ...
                            <a href="<?php $this->author->permalink(); ?>" class="mr-2" title="<?php echo '作者'; ?>: <?php $this->author(); ?>">
                                <?php $this->author(); ?>
                            </a>
                        </span>
                        ...
                        <a href="<?php echo $this->options->adminUrl . 'write-page.php?cid=' . $this->cid; ?>"><?php echo '编辑'; ?></a>
                    </span>
                        <?php endif; ?>
                    </div>
